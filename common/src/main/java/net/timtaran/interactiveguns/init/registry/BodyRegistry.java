...
public class BodyRegistry {
    ...
    public static final VxBodyType<DeagleFrame> DEAGLE_FRAME = VxBodyType.Builder
            .<DeagleFrame>create(DeagleFrame::new)
            .rigidProvider(DeagleFrame::createJoltBody)
            .behaviors(builder -> builder
                    .add(new VxNetSyncBehavior())
                    .add(new VxSynchronizedDataBehavior(DeagleFrame::defineSyncData))
    ...
    public static final VxBodyType<DeagleMagazine> DEAGLE_MAGAZINE = VxBodyType.Builder
            ...
            .behaviors(builder -> builder
                    .add(new VxNetSyncBehavior())
                    .add(new VxSynchronizedDataBehavior(DeagleMagazine::defineSyncData))
                    .add(new VxPersistenceBehavior(DeagleMagazine::writePersistenceData, DeagleMagazine::readPersistenceData))
                    .add(new VxSummonableBehavior())
                    .add(new VxKillBehavior())
            )
    ...
    public static void registerClient() {
        ...
        registry.registerClientFactory(DEAGLE_MAGAZINE.getTypeId(), DeagleMagazine::new);
        registry.registerClientFactory(DEAGLE_SLIDE.getTypeId(), DeagleSlide::new);
