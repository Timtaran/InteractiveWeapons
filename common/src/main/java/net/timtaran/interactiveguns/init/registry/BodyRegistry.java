...
public class BodyRegistry {
     ...
     */
    public static final VxBodyType DEAGLE_FRAME = VxBodyType.Builder
    ...
    public static final VxBodyType DEAGLE_CHAMBER = VxBodyType.Builder
            .create(Deagle::create)
            .rigidProvider(DeagleFrame::createJoltBody)
            .behavior(VxNetSyncBehavior.ID)
            .behavior(VxSyncBehavior.ID)
    ...
    public static final VxBodyType DEAGLE_BOLT = VxBodyType.Builder
            .create(Deagle::create)
            .rigidProvider(DeagleFrame::createJoltBody)
            .behavior(VxNetSyncBehavior.ID)
            .behavior(VxSyncBehavior.ID)
    ...
    public static void register() {
        ...
        VxBodyRegistry.getInstance().register(DEAGLE_CHAMBER);
        VxBodyRegistry.getInstance().register(DEAGLE_BOLT);
    }
    ...
    public static void registerClient() {
        ...
        registry.registerClientFactory(DEAGLE_CHAMBER.getTypeId(), DeagleFrame::new);
        registry.registerClientFactory(DEAGLE_BOLT.getTypeId(), DeagleFrame::new);

        // Client-side renderer registration
        registry.registerClientRenderer(DEAGLE_FRAME.getTypeId(), new DeagleFrameRenderer());
//        registry.registerClientRenderer(DEAGLE_CHAMBER.getTypeId(), new DeagleChamberRenderer());
//        registry.registerClientRenderer(DEAGLE_BOLT.getTypeId(), new DeagleBoltRenderer());
    }
}
