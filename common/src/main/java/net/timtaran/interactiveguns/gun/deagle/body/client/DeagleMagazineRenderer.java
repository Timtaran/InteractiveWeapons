...
public class DeagleMagazineRenderer extends VxBodyRenderer<VxBody> {
    @Override
    public void render(VxBody body, PoseStack poseStack, MultiBufferSource bufferSource, float partialTicks, int packedLight, VxRenderState renderState) {
        ...
        DeagleFrameModel.getMagazine().render(poseStack, consumer, packedLight, OverlayTexture.NO_OVERLAY);
